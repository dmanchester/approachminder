...
test("trajectoriesFromParsedJSON() should correctly construct a Trajectories instance from parsed JSON", () => {
  ...
  expect(trajectoryA.timeBasedPositions[0].time.equals(JulianDate.fromIso8601("2023-01-01T00:00:01Z"))).toEqual(true);  // supplied second in parsedJSON, but is chronologically first
